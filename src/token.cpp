...
// string conversion of token kinds for debug and error messaging
std::string toString(TokenKind k) {
    ...
    case TokenKind::TYPE_IDENT:
        return "TYPE_IDENT";
    case TokenKind::TYPE_LIST:
        return "TYPE_LIST";
    case TokenKind::VAR_TYPE:
        return "VAR_TYPE";
    case TokenKind::TYPE_VAR:
        return "TYPE_VAR";
    case TokenKind::PARAM_LIST:
        return "PARAM_LIST";
    case TokenKind::TYPE_PARAM_LIST:
    ...
    case TokenKind::DATA:
        return "DATA";
    case TokenKind::CTOR_DECL:
        return "CTOR_DECL";
    case TokenKind::MATCH:
        return "MATCH";
    case TokenKind::PATTERN:
        return "PATTERN";
    case TokenKind::PATTERN_CLAUSE:
        return "PATTERN_CLAUSE";
    case TokenKind::EQ:
        return "EQ";
    case TokenKind::EQUALS:
        return "EQUALS";
    case TokenKind::SHIFT:
        return "SHIFT";
    case TokenKind::RESET:
        return "RESET";
    case TokenKind::FORCE:
        return "FORCE";
    case TokenKind::DO:
        return "DO";
    case TokenKind::NIL:
